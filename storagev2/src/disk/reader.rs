...
pub struct DiskStorageReader {
    ...
    // consumer_group -> DiskStorageReaderSession
...
impl DiskStorageReader {
    pub fn new(conf: ReaderConfig) -> Self {
...
impl StorageReader for DiskStorageReader {
    ...
    async fn new_session(
        ...
        let session = DiskStorageReaderSession::new(group_id, self.conf.clone(), read_position)
            .await
        ...
        self.sessions.insert(group_id.to_string(), session.clone());
...
//         use crate::{
//             ConsumerReaderPosition, MessagePayload, SegmentOffset, StorageWriter,
...
//             .new_session(
//                 group_id,
//                 vec![(topic.to_string(), ConsumerReaderPosition::Earliest)],
//             )
//             .await
...
//             .new_session(
//                 group_id + 1,
//                 vec![(topic.to_string(), ConsumerReaderPosition::Latest)],
//             )
//             .await
